...
//	  }
  ...
  {
	  Picture america = new Picture("americanflag.jpg");
	  Picture mexico = new Picture("mexico.jpg");
	  this.copy(mexico, 0, 10);
	  this.copy(america, 150, 0);
	  this.copy(mexico, 300, 10);
	  this.copy(america, 450, 0);
	  this.copy(mexico, 0, 849);
